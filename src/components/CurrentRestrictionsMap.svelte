...
onMount(() => {
  ...
  map = new mapbox.Map({
    ...
    accessToken: 'pk.eyJ1IjoibG9ja3AiLCJhIjoiY2s0MXE0azU1MDNtaDNrcnczZDlra2VvciJ9.r6EUZP49b1DR9JVVfxOzIQ',
  ...
  map.on('load', function() {
    ...
    map.setFilter('terrible-countries', ["!in",
        "iso_3166_1_alpha_3",
        'AUT',
        'NLD',
        'ITA',
